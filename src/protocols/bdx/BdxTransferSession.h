...
public:
     ...
     *        callback    OutputEventCallback that is to be registered with the transfer session and gets called when Output events
     *                    are generated.
     */
    void RegisterOutputEventCallback(void * context, OutputEventCallback callback);
     ...
     *                    are generated.
     */
    void UnregisterOutputEventCallback(OutputEventCallback callback);
